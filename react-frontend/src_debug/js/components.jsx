  ...
  return (
    <div className={bemBlocks.item().mix(bemBlocks.container("item"))} data-qa="hit">
      ...
      <ul style={{marginTop: 8, marginBottom: 8, marginLeft: 0, paddingLeft: 0, listStyle: 'none' }}>
        ...
        <li>Range of Premiums: <span className={'hits-details'}> ${ parseInt(premium_q1) }</span></li>
        <li>Average Monthly Premiums: <span className={'premiums'}> ${ parseInt(premium) } </span></li>
